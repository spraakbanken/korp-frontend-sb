...
settings.corpora["npegl-eng"] = {
    ...
    attributes: {
        ...
        np_gender: {label: "gender", isStructAttr: true, order: 130, extendedComponent: "structServiceSelect"},
        ...
        np_degree_of_interest: {label: "np_degree_of_interest", isStructAttr: true, order: 180, extendedComponent: "structServiceSelect"},
